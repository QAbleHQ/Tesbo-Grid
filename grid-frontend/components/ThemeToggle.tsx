...
export default function ThemeToggle({ collapsed = false }: { collapsed?: boolean }) {
  ...
  return (
    <div className={`glass-subtle inline-flex items-center p-1 ${collapsed ? "flex-col" : ""}`}>
      {(["light", "dark"] as ThemeMode[]).map((mode) => {
        ...
        return (
          <button
            ...
            className={`inline-flex items-center gap-2 rounded-xl px-3 py-2 text-[13px] font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color-mix(in_oklab,var(--brand-primary)_30%,transparent)] ${
              active
